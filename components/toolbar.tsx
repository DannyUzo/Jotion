...
export const Toolbar = ({initialData, preview}: ToolbarProps) => {
    ...
    return (
        <div className="pl-[54px] group relative">
            {!!initialData && !preview && (
                <div className="flex items-center gap-x-2 group/icon pt-6">
                    <IconPicker onChange={onIconselect}>
                        <p className="text-6xl  transition">{initialData.icon}</p>
                    </IconPicker>
            ...
            <div className="opacity-0 group-hover:opacity-100 gap-x-1 py-4 flex items-center">
                ...
                {!initialData.coverImage && !preview && (
                    <Button onClick={coverImage.onOpen} className="text-muted-foreground text-sx" variant="outline">
