...
const Item = ({id, label, onClick, icon: Icon , documentIcon, expanded, onExpand, isSearch, active, level = 0 ,}: ItemProps) => {
 ...
 onExpand?.();
  ...
  return (
    <div
      ...
      className={cn("group min-h-[20px] py-1 pr-3 text-sm w-full hover:bg-primary/5 flex items-center text-muted-foreground text-medium", active && "bg-primary/5 text-primary")}
    >
      {!!id && (
      ...
      {!!id && (
        <div className="ml-auto flex items-center gap-x-2">
         ...
         <div role="button" onClick={onCreate} className="opacity-0 h-full ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 group-hover:opacity-100 ">
