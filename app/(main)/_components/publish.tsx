       ...
       <Popover>
        <PopoverTrigger asChild>
            <Button size="sm" variant="ghost">
                Publish
                {initialData.isPublished && <Globe className="text-sky-400 w-4 h-4 ml-2"/>}
            </Button>
        </PopoverTrigger>
            ...
            {initialData.isPublished ? (
                <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                        <input className="flex-1 px-2 border text-xs rounded-l-md h-8 bg-muted truncate" value={url}/>
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-xs text-muted-foreground mb-4">Share this note with others</span>
                    <Button disabled={isSubmitting} onClick={onPublish} className="w-full text-xs">Publish</Button>
                </div>
            )}
        </PopoverContent>
       </Popover>
